...
def find_largest(li):  # TODO: Rename this function to reflect what it's doing.
    m = li[0]
    for value in li:
        if value > m:
            m = value
...
############################
def sentence_splitter(sentence):  # TODO: Rename this function to reflect what it's doing.
